        ...
        <div class="row mb-5">
            <div class="col-md-12">
             ...
             <div class="d-flex align-items-center justify-content-between">
                <h4>Users</h4>
                <a href="{{ route('createUser') }}" class="admin-head-btn">Create User</a>
             </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="blog-list-actions">
                                        <a href="{{ route('updateUser', ['id' => $user->id]) }}" class="blog-list-edit"><i class="fa-solid fa-pen-to-square"></i></a>
